...
from models.hcum.hcum import HCUM
from datasets.ssl_dataset import *
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset in ['cifar10', 'cifar100', 'stl10']:
        ...
        train_dset = SSL_Dataset(args, alg='hcum', name=args.dataset, train=True,
                                num_classes=args.num_classes, data_dir=args.data_dir)
        lb_dset, ulb_dset = train_dset.get_ssl_dset(args.num_labels)

        _eval_dset = SSL_Dataset(args, alg='hcum', name=args.dataset, train=False,
                                num_classes=args.num_classes, data_dir=args.data_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='hcum')
    ...
    '''
    parser.add_argument('--net', type=str, default='DenseNet169')
